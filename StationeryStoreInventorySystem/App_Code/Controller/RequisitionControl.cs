...
public class RequisitionControl
{
    ...
    public static List<ReqisitionListItem> DisplaySearch(string searchWord)
    {
        ...
        {
            searchList = itemList.Where(x => x.Date.ToLower().Contains(searchWord.ToLower()) || x.Department.ToLower().Contains(searchWord.ToLower()) || x.Status.ToLower().Contains(searchWord.ToLower())).ToList();
        }
        return searchList;
    }
    ...
    public static List<ReqisitionListItem> SearchForRepRequisitionWithStatus(string searchWord, int empID, string status)
    {
        ...
        searchList = list.Where(x =>x.Date.ToString().Contains(searchWord.ToString())).ToList();
    ...
    public static List<ReqisitionListItem> SearchForRepRequisitionWithoutStatus(string searchWord, int empID)
    {
        ...
        searchList = list.Where(x =>Convert.ToDateTime(x.Date).ToLongDateString().Contains(searchWord.ToString())).ToList();
    ...
    public static List<ReqisitionListItem> DisplaySearchByEmpID(string searchWord,int empId)
    {
        ...
        foreach (ReqisitionListItem i in itemList)
        {
            searchList = itemList.Where(x => x.Date.ToLower().Contains(searchWord.ToLower())|| x.EmployeeName.ToLower().Contains(searchWord.ToLower()) || x.Status.ToLower().Contains(searchWord.ToLower())).ToList();
        }
        return searchList;
    }
    ...
    public static List<ReqisitionListItem> DisplayCollectionListSearch(string deptCode, string searchWord)
    {
        ...
        {
            searchList = l.Where(x => x.Date.ToLower().Contains(searchWord.ToLower())).ToList();
        }
        return searchList;
    }
