...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    </div><%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RequisitionListDepRep.aspx.cs" Inherits="ReqisitionListEmployee" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
      ...
      <asp:TextBox ID="TextBox1" runat="server" Width="311px"></asp:TextBox>
           <asp:button ID="Button1" runat="server" Text="Search"  CssClass="button" OnClick="SearchBtn_Click"/>
           <asp:button ID="Button2" runat="server" Text="Display All" CssClass="button" OnClick="DisplayBtn_Click"/>
    </div>
    <div>

        <div>
        <asp:Label ID="Label6" runat="server" Text="To View Your Requested Requisition by Status : "></asp:Label>
