<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PurchaseOrderDetailClerk.aspx.cs" Inherits="PurchaseOrderDetailClerk" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <br />
    <asp:Button ID="Button1" runat="server" Text="Close Purchase Order" CssClass="button" />
</asp:Content>
