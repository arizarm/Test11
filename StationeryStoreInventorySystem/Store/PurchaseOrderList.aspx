            ...
            <asp:TemplateField HeaderText="Date">
                   <%-- <EditItemTemplate>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="orderDate" runat="server" Text='<%# Bind("OrderDate") %>' Font-Bold="true" ></asp:Label>
                    </ItemTemplate> 
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Purchase Order">
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="purchaseDetailLinkBtn" runat="server" Text='<%# Eval("PurchaseOrderID") %>' CommandArgument='<%# Eval("PurchaseOrderID") %>' OnClick="purchaseDetailLinkBtn_Click" Font-Bold="true"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Requested by">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="ReqstdBy" runat="server" Text='<%# Bind("Employee.EmpName") %>' Font-Bold="true"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Supplier">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="SupplierCode" runat="server" Text='<%# Bind("Supplier.SupplierName") %>' Font-Bold="true"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Status">
                   <%-- <EditItemTemplate>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="OrderStatus" runat="server" Text='<%# Bind("Status") %>' Font-Bold="true"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
