                ...
                if (!isSame) {
                    ...
                    new AsyncTask<Department, Void, Void>() {
                        ...
                        protected void onPreExecute() {
                            progress = ProgressDialog.show(UpdateCollectionPointActivity.this, "Update Collection Point", "Sending mail to store clerks", true);
                        }
...
//       name.setVisibility(View.GONE);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (role.equals("Representative")) {
            getMenuInflater().inflate(R.menu.deptrepmenu, menu);
        }else {
